...
def rgb_clustering(new_image_path, user_id, folder_path=None, model_path=None, image_size=(1000, 1000), cluster_num=4):
    """
    __summary__
    ...
    """
    # 이미지 데이터 로드 및 전처리
    def load_images(folder_path, target_size=image_size):
        images = []
        filenames = []
