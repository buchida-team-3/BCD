...
function Image(props) {
  ...
  function Pages() {
    ...
    return (
      ...
      <>
        ...
        <Page position={[width * 0.3, 0, 0]} urls={['album/img1.jpg', 'album/img2.jpg', 'album/img3.jpg']} />

        <Page position={[width * 2, 0, 0]} urls={['album/img4.jpg', 'album/img5.jpg', 'album/img6.jpg']} />

        <Page position={[width * 3.7, 0, 0]} urls={['album/img7.jpg', 'album/img8.jpg', 'album/img9.jpg']} />

        <Page position={[width * 5.4, 0, 0]} urls={['album/img10.jpg', 'album/img11.jpg', 'album/img12.jpg']} />

        <Page position={[width * 7.1, 0, 0]} urls={['album/img13.jpg', 'album/img14.jpg', 'album/img15.jpg']} />
  ...
  export default function ImageContent7() {
