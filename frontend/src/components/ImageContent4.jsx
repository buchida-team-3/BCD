...
function Image(props) {
  ...
  function Pages() {
    ...
    return (
      ...
      <>
        ...
        <Page position={[width * 0.3, 0, 0]} urls={['mountain/img1.jpg', 'mountain/img2.jpg', 'mountain/img3.jpg']} />

        <Page position={[width * 2, 0, 0]} urls={['mountain/img4.jpg', 'mountain/img5.jpg', 'mountain/img6.jpg']} />
  ...
  export default function ImageContent4() {
