...
function Image(props) {
  ...
  function Pages() {
    ...
    return (
      ...
      <>
        ...
        <Page position={[width * 0.3, 0, 0]} urls={['jeju/img1.jpg', 'jeju/img2.jpg', 'jeju/img3.jpg']} />

        <Page position={[width * 2, 0, 0]} urls={['jeju/img4.jpg', 'jeju/img5.jpg', 'jeju/img6.jpg']} />
  ...
  export default function ImageContent6() {
